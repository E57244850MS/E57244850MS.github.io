    ...
    class Renderer {
        ...
        */
        ...
        _createEnvironment(playground) {
            ...
            playground.lakes.forEach((lake, i) => {
        ...
        addThingView(thing) {
            ...
            switch (thing.type) {
                ...
                case ThingType.BEE:
                    ...
                    let beeBody = this.scene.getMeshByName('beeBody').createInstance('beeBody' + thing.id);
                    let beeHead = this.scene.getMeshByName('beeHead').createInstance('beeHead' + thing.id);
                    let beeSting = this.scene.getMeshByName('beeSting').createInstance('beeSting' + thing.id);
                    let beeWings = this.scene.getMeshByName('beeWings').createInstance('beeWings' + thing.id);
        ...
        animateHiveCollision(hiveThing) {
