...
define(["require", "exports"], function (require, exports) {
    ...
    class CustomMesh {
        ...
        static createLake(lake, name, scene) {
            let planes = lake.rects.map((rect) => {
        ...
        static createTriangularPrism(name, scene, updatable = false) {
        ...
        static createOctahedron(name, scene, updatable = false) {
        ...
        static createPyramid(name, scene, updatable = false) {
        ...
        static normalizePyramidTexture(texture) {
            texture.uScale = 1;
            texture.vScale = -.665;
        }
        static createGroundFromHeightMap(name, buffer, bufferWidth, bufferHeight, width, height, subdivisions, minHeight, maxHeight, scene, updatable) {
